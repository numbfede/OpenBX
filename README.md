...
- **Game profiles** — local Steam / Epic / Ubisoft Connect / Xbox / Start Menu detection. Per-game change is the documented Windows GPU preference plus windowed-game optimizations
